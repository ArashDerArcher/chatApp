fucntion makeHandleEvent(client, clientManager, chatroomManager) {
...
module.exports = function (client, clientManager, chatroomManager) {
  const handleEvent = makeHandleEvent(cleint, clientManager, chatroomManager)
  ...
  function hanfleJoin(chatroomName, callback) {
    const createEntry = () => ({ event: `joind ${chatroomName}`})

    function handleEvnt(chatroomName, createEntry)
  ...
  function handleGetChatrooms(_, callbacl) {
  ...
  function handleDisconnect(){
    ...
    clientManager.removeCliet(client)
